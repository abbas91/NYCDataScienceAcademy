...
#Here the MSE is much lower at approximately 89,722; a further improvement
...
#The MSE is a bit larger for the overall dataset at approximately 98,033; this
#is to be expected since now we're using all of our data.
...
#The MSE is a bit larger for the overall dataset at approximately 94,850; this
#is to be expected since now we're using all of our data.

#In this scenario, the MSE of both the ultimate ridge and lasso regressions
#were comparable with the lasso being a bit smaller (Ridge MSE: 98,033,
#Lasso MSE: 94,850). The lasso has the substantial advantage over ridge
